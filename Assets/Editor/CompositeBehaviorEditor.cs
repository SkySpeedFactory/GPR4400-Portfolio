...
public class CompositeBehaviorEditor : Editor
{
    ...
    //    else
    //    {
    //        r.x = 30f; // padding in Inpector
    //        r.width = EditorGUIUtility.currentViewWidth - 95f;// value in pixels aka. 95 pixels
    //        EditorGUI.LabelField(r, "Behaviors");
    //        r.x = EditorGUIUtility.currentViewWidth - 65f;//value in pixels
    //        r.width = 60f;
    ...
    //        }
    //        if (EditorGUI.EndChangeCheck())//checks for ui changes
    //        {
    //            EditorUtility.SetDirty(cb);// lets unity know scriptable object has been changed and needs to be saved
    //        }                              
    //    }
    //
    //    EditorGUILayout.EndHorizontal();
